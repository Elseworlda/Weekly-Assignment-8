Public Class Form1
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboMonths.SelectedIndexChanged
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        lblMaxSavings.Text = ""
        If IO.File.Exists("C:\Users\astro\Downloads\savings.txt") = True Then
            objReader = IO.File.OpenText("C:\Users\astro\Downloads\savings.txt")
            ...
            Next
        Else
            MsgBox("The file is not available. Restart the program when the file is available.")
            Close()
        End If
    End Sub
